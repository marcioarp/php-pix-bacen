 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CobPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CobPayload';
...
'devedor' => '',
'status' => 'string',
'valor' => '\Swagger\Client\Model\CobPayloadValor'    ];
...
self::STATUS_REMOVIDO_PELO_PSP,        ];
     ...
     * Gets valor
     *
     * @return \Swagger\Client\Model\CobPayloadValor
     */
     ...
     * Sets valor
     *
     * @param \Swagger\Client\Model\CobPayloadValor $valor valor
     *
     * @return $this
     */
