 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LoteCobVGerado implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoteCobVGerado';
...
'descricao' => 'string',
'criacao' => '\DateTime',
'cobsv' => '\Swagger\Client\Model\CobVGerada[]'    ];
...
'cobsv' => 'getCobsv'    ];
     ...
     * Sets cobsv
     *
     * @param \Swagger\Client\Model\CobVGerada[] $cobsv cobsv
     *
     * @return $this
     */
